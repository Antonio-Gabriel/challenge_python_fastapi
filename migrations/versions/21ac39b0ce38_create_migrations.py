...
Revision ID: 21ac39b0ce38
Revises: 
Create Date: 2022-04-14 08:15:59.006705
...
def upgrade():
    ...
    sa.Column('user_type', postgresql.ENUM('staff', 'teacher', 'student', name='user_type'), nullable=False),
